 ...
 */
public class ApiWatcherDemo2 implements Watcher {
    ...
    public static void deleteWatcher_Children(String path, String children) throws Exception
    {
        ...
        List<String> pathChildren = zookeeper.getChildren(path, new ApiWatcherDemo2());
        System.out.println("deleteWatcher_Children：" + path + "的子节点：" + pathChildren);
        // 利用exists，对子节点添加Watcher
        Stat childrenStat = zookeeper.exists(path + children, new ApiWatcherDemo2());
    ...
    public static void deleteWatcher(String path) throws Exception
    {
        ...
        Stat stat = zookeeper.exists(path, new ApiWatcherDemo2());
    ...
    public static void setDataWatcher(String path, String value) throws Exception
    {
        countDownLatch = new CountDownLatch(1);
        Stat stat = new Stat();
        byte[] bytes = zookeeper.getData(path, new ApiWatcherDemo2(), stat);
    ...
    {
        zookeeper = new ZooKeeper(CONNECTSTRING, 10000, new ApiWatcherDemo2());
